...
function ready() {
   ...
   // document.getElementsByClassName('btn-purchase')[0].addEventListener('click', tableSelect)
...
function proc() {
    ...
    for (let i = 0; i < len; i++) {
        ...
        var cost = cartItems.getElementsByClassName('cart-price')[i].innerText.replace('$', '')
        var quantity = cartItems.getElementsByClassName('cart-quantity-input')[i].value
        var entry = {
            index : i,
            entryName: name,
            entryCost: cost,
